...
import { ArrowRight, Blocks, Layers, Leaf, Lock, Plus, type LucideIcon } from "lucide-react";
...
const STAT_CHIPS: StatChip[] = [
  { icon: Layers, value: "6", label: "product lines", duration: 9, delay: 0, offset: "lg:mr-16" },
  { icon: Blocks, value: "8", label: "source projects", duration: 12, delay: 0.8, offset: "lg:mr-0" },
  { icon: Lock, value: "100%", label: "on-prem inference", duration: 10, delay: 1.6, offset: "lg:mr-24" },
];
...
function EcgLine() {
  ...
  return (
    <svg
      ...
      role="img"
      aria-label="Animated heartbeat trace — the Willow signature"
    >
      <path
        d={d}
        fill="none"
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
          <div>
            ...
            <Reveal delay={0.08}>
              ...
              >
                Willow Health AI Suite
              </h1>
            </Reveal>

            <Reveal delay={0.16}>
              <p className="mt-5 max-w-2xl text-lg font-semibold leading-snug text-terracotta sm:text-xl">
                From eight open-source medical AI projects to one governed clinical AI stack —
                built for clinical operations, not for the lab.
              </p>
            </Reveal>

            <Reveal delay={0.24}>
              <p className="mt-4 max-w-2xl text-base leading-relaxed text-ink/80">
                Willow packages eight of the strongest open medical AI models behind a governance
                layer your compliance team can actually read — de-identification, citation
                grounding, clinician sign-off, and a full audit trail. Six product lines meet
                clinicians inside the EHR workflow, from discharge summaries to telehealth triage.
                Run it on your own GPUs, inside your own walls, under your own policies.
              </p>
            </Reveal>
            ...
            <Reveal delay={0.32}>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                >
                  <a href="#compliance">Read the compliance plan</a>
                </Button>
              </div>
            </Reveal>
          </div>
