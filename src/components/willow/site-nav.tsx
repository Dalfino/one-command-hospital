...
import { NAV_LINKS } from "./willow-data";
    ...
    <header className="sticky top-0 z-50 border-b border-sage/40 bg-cream/70 backdrop-blur-md supports-[backdrop-filter]:bg-cream/60">
      ...
      >
        <a
          ...
          aria-label="Willow Health AI — back to top"
        >
          <motion.span
            aria-hidden
            className="flex h-9 w-9 items-center justify-center rounded-full bg-forest text-cream"
        ...
        <div className="flex items-center gap-2">
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="right" className="w-80 border-sage/40 bg-cream">
